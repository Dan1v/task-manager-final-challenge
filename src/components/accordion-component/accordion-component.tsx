...
export const AccordionTrigger: React.FC<AccordionTriggerProps> = ({ children }) => (
  <AccordionPrimitive.Header>
    <AccordionPrimitive.Trigger className=" flex w-full items-center gap-2 text-left text-lg font-semibold text-neutral-300 hover:text-white py-3 pl-4 bg-neutral4 rounded-sm border border-neutral3 group">
      <svg
