...
export default function SideBarContainer() {
  ...
  return (
    <aside className={styles.containerSideBar}>
      <Link href={'/'}>
        <Image src={staticImages.RavnLogo} alt="RavnLogo" className=" mt-3.5" />
      </Link>
      <div className=" w-full mt-11 flex flex-col gap-2">
        <Link href={'/'} className={styles.buttonSideBarDashboard(pathname)}>
          <svg
        ...
        <Link href={'/my-tasks'} className={styles.buttonSideBarMyTasks(pathname)}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="24"
